...
//        {
//            // task1.
//            //Console.WriteLine("Введите начальный и конечный индексы:");
...
//            //string[] products = { "Сахар", "Хлеб", "Сметана", "Молоко", "Чай" };
//            //double[] prices = { 1.2, 2.0, 1.5, 3.0, 2.5 };

//            //Console.WriteLine("Список продуктов и цены:");
//            //for (int i = 0; i < products.Length; i++)
//            //{
//            //    Console.WriteLine($"{products[i]}: {prices[i]} биткоинов");
//            //}

//            //Console.WriteLine("Сканируйте продукт: ");
...
//            //Console.WriteLine($"Общая сумма: {totalCost} kzt");
...
//        if (end < start)
//        {
//            throw new ArgumentException("Индекс должен быть больше или равен начальному индексу.");
//        }
